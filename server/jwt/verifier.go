// based on https://github.com/GoogleIdTokenVerifier/GoogleIdTokenVerifier
package jwt
...
//GetCertsFromURL is
func GetCertsFromURL(serviceAccount string) []byte {
	res, _ := http.Get(fmt.Sprintf("https://www.googleapis.com/service_accounts/v1/metadata/jwk/%s", serviceAccount))
